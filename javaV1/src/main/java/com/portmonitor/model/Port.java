...
/**
 * Model class representing a network port.
 */
public class Port {
    ...
    public boolean equals(Object o) {
        ...
        return portNumber == port.portNumber &&
                ...
                Objects.equals(state, port.state) &&
                Objects.equals(processName, port.processName);
    }

    @Override
    public int hashCode() {
        return Objects.hash(portNumber, protocol, state, processName, pid);
    }
